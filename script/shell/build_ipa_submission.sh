...
xcodebuild clean -workspace blackjack.xcworkspace -scheme blackjack -configuration Submission
xcodebuild archive -workspace blackjack.xcworkspace -scheme blackjack -configuration Submission
